    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center border-b pb-3 mb-4">
                ...
                <a href="{{ route('books.index') }}" class="btn btn-sm btn-link text-decoration-none text-muted">Back to
                    List</a>
            </div>
            ...
            <form action="{{ route('books.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required class="form-control bg-light">
                </div>

                <div class="mb-3">
                    <label class="form-label text-secondary small fw-semibold">Author</label>
                    <input type="text" name="author" value="{{ old('author') }}" required class="form-control bg-light">
                </div>

                <div class="mb-3">
                    <label class="form-label text-secondary small fw-semibold">Blurb / Description</label>
                    <textarea name="blurb" rows="3" required class="form-control bg-light">{{ old('blurb') }}</textarea>
                </div>
